...
from extension.jira.extension_locust import app_specific_action, app_specific_action_2
...
class JiraBehavior(MyBaseTaskSet):
    ...
    @task(config.percentage('standalone_extension_2'))  # By default disabled
    def custom_action_2(self):
        app_specific_action_2(self)
